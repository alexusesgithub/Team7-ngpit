export default function Home({ onLaunchModule1, onLaunchModule2, onLaunchModule3, onLaunchModule4 }: { onLaunchModule1: () => void, onLaunchModule2: () => void, onLaunchModule3: () => void, onLaunchModule4: () => void }) {
    return (
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-3xl shadow-sm hover:shadow-xl border border-slate-200 p-8 md:p-10 transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                            ...
                            <button onClick={onLaunchModule4} className="inline-flex items-center gap-2 font-bold text-cyan-600 hover:text-cyan-800 transition-colors w-max">
