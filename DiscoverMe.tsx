        ...
        {currentStep === 0 && (
          <div className="text-center animate-in fade-in slide-in-from-bottom-8 duration-700 mt-10">
            ...
            <button 
              ...
              className="px-10 py-5 font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-full shadow-lg shadow-blue-600/30 hover:shadow-xl hover:scale-105 transition-all duration-300 text-lg flex items-center gap-2 mx-auto"
            >
          ...
          <div className="animate-in fade-in zoom-in-95 duration-700">
            ...
            <div className="flex justify-center mt-12">
              <button 
                ...
                className="px-8 py-3 rounded-full font-bold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 hover:text-blue-600 hover:border-blue-200 transition-all shadow-sm flex items-center gap-2 group"
              >
